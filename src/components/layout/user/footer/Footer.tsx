         ...
         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-around items-center md:space-y-0 space-y-6">
               <div className="flex items-center">
                  <Link to="/">
                     <img src="/thesis_7293014.png" alt="Windear" className="h-10 w-auto" />
                  </Link>
                  <p className="ml-2">
               ...
               <div className="flex items-center">
                  ...
                  <Link to="https://github.com/TranXuanPhong25/windear" target="_blank" className="text-white hover:text-gray-400 mx-2 dark:[&>svg]:fill-white">
